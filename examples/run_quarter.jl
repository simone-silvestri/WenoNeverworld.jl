...
output_dir = "/storage4/WenoNeverworldData/quarter_degree_new/"
@show output_prefix = output_dir * "weno_quarter_" 
...
init_file   = output_dir * "weno_quarter_checkpoint_iteration100800.jld2" # To restart from a file: `init_file = /path/to/restart`
