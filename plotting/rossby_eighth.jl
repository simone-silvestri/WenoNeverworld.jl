...
@info "Loading data..."
path = pwd()
hfile = jldopen("/storage3/WenoNeverworldData/weno_eighth_checkpoint_iteration14836874.jld2", "r")
...
ax = Axis(fig[1, 1], xlabel="Longitude [∘]", xlabelsize = 20, xticklabelsize = 20, ylabel="Latitude [∘]", ylabelsize = 20,title="1/8∘" ,  yticklabelsize = 20, titlesize=25, aspect=0.5, xticks=0:20:60, yticks=-70:20:70)
...
ax = Axis(fig[1, 1], xlabel="Longitude [∘]", xlabelsize = 40, xticklabelsize = 40, ylabel="Latitude [∘]", ylabelsize = 40,title="1/8∘" ,  yticklabelsize = 40, titlesize=45, aspect=0.5, xticks=0:20:60, yticks=-70:20:70, background_color = :transparent)
#hm = heatmap!(ax, collect(lon), collect(lat), log10.(ross_2d .+ eps(1000.0)), colorrange = (3, 5), aspect_ratio = 0.5,colormap = :plasma)
