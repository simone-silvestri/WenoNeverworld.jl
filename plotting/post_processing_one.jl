...
function plot_and_save_heatmap(data, filename, title, xlabel, ylabel; colorrange = (0, 0.02), level =10)
    ...
    ax = Axis(fig[1, 1], xlabel=xlabel, xlabelsize=30, yticks=-4000:20:6000, xticklabelsize=30, ylabel=ylabel, ylabelsize=30, xticks=0:20:140, yticklabelsize=30, title=title, titlesize=50)
...
#plot_and_save_heatmap(interior(vbᵢ_avg,1, :, :), "time_averaged_one_moc", "Time-Averaged MOC 1∘", "latitude [∘]", "depth [m]", colorrange = (-5e-5, 9e-5))
#plot_and_save_heatmap(interior(u′[20], :, :, 69), "time_averaged_u", "Time-Averaged u 1∘", "latitude [∘]", "depth [m]", colorrange = (0, 0.02))
plot_and_save_heatmap(interior(IKE[20], :, :, 69), "time_averaged_one_IKE", "Time-Averaged IKE 1∘", "longitude [∘]", "latitude [∘]", colorrange = (0, 0.02))
plot_and_save_heatmap(interior(EKE[20], :, :, 69), "time_averaged_one_EKE", "Time-Averaged EKE 1∘", "longitude [∘]", "latitude [∘]", colorrange = (0, 0.02))
plot_and_save_heatmap(interior(MKE, :, :, 69), "time_averaged_one_MKE", "Mean Kinetic Energy 1∘", "longitude [∘]", "latitude [∘]", colorrange = (0, 0.02))
...
fig = Figure(resolution=(2000, 1000))
ax = Axis(fig[1, 1], xlabel="Latitude [∘]", xlabelsize=30, yticks=-4000:1000:0, xticklabelsize=30, ylabel="Depth [m]", ylabelsize=30, xticks=-90:20:1120, yticklabelsize=30, title="Heatmap of Time-Averaged b 1", titlesize=50)
