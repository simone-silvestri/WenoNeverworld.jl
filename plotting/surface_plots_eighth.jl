...
f = all_fieldtimeseries("weno_eighth_checkpoint_iteration9975074.jld2", "/storage3/WenoNeverworldData/"; checkpointer = true)
...
using CairoMakie
CairoMakie.activate!()
CairoMakie.save("vort_eighth.png", fig, px_per_unit = 5)
=#
...
using CairoMakie
CairoMakie.activate!()
CairoMakie.save("surf_temp_eighth_cb.png", fig, px_per_unit = 5)