...
function load_ape_with_time(prefix, dir; stride=5)
...
for (prefix, dir, _) in simulations
    ...
    ape, time_years = load_ape_with_time(prefix, dir; stride=5)
    println("Saved: $(prefix)_ape_with_time.jld2")
end
...
display(fig)
save("figures/ape_vs_time1.png", fig)
