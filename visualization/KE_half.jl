...
@info "Loading data..."
path = pwd()
hfile = jldopen("/storage4/WenoNeverworldData/half_degree_new/weno_half__checkpoint_iteration13154400.jld2", "r")
keys(hfile)
...
display(fig)
CairoMakie.activate!()
CairoMakie.save("figures/TKE_half_cb.png", fig, px_per_unit = 5)
#########
...
using CairoMakie
CairoMakie.activate!()
CairoMakie.save("figures/KE_half.png", fig, px_per_unit = 5)
##
