...
dir = "/storage4/WenoNeverworldData/half_degree_new/"
...
hfile_1 = jldopen("/storage4/WenoNeverworldData/half_degree_new/weno_half__checkpoint_iteration13154400.jld2", "r")
...
ax = Axis(fig[1, 1], xlabel="Latitude [∘]", xlabelsize=30, yticks=-4000:1000:0, xticklabelsize=30, ylabel="Depth [m]", ylabelsize=30, xticks=-90:20:1120, yticklabelsize=30, title="1/2∘", titlesize=50, aspect=2.0)
...
display(fig)
save("figures/ta_strat_half.png", fig)