...
@info "Loading data..."
path = pwd()
hfile = jldopen("/storage4/WenoNeverworldData/quarter_degree_new/weno_quarter__checkpoint_iteration69830400.jld2", "r")
keys(hfile)
...
CairoMakie.activate!()
CairoMakie.save("figures/KE_quarter.png", fig, px_per_unit = 5)
##
