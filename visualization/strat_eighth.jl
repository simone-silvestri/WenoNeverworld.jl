...
dir = "/storage4/WenoNeverworldData/eighth_degree_new/"
...
hfile_1 = jldopen("/storage4/WenoNeverworldData/eighth_degree_new/weno_eighth_checkpoint_iteration8169120.jld2", "r")
...
ax = Axis(fig[1, 1], xlabel="Latitude [∘]", xlabelsize=30, yticks=-4000:1000:0, xticklabelsize=30, ylabel="Depth [m]", ylabelsize=30, xticks=-90:20:1120, yticklabelsize=30, title="1/8∘", titlesize=50, aspect=2.0)
...
display(fig)
save("figures/ta_strat_eighth2.png", fig)