...
dir = "/storage4/WenoNeverworldData/quarter_degree_new/"
prefix    = "weno_quarter__check"
variables = ("u", "v", "w", "b")
# stride = 3
...
hfile_1 = jldopen("/storage4/WenoNeverworldData/quarter_degree_new/weno_quarter__checkpoint_iteration70005600.jld2", "r")
...
ax = Axis(fig[1, 1], xlabel="Latitude [∘]", xlabelsize=30, yticks=-4000:1000:0, xticklabelsize=30, ylabel="Depth [m]", ylabelsize=30, xticks=-90:20:1120, yticklabelsize=30, title="1/4∘", titlesize=50, aspect=2.0)

hm = heatmap!(ax, lat, z, b_r[lon_index, :, :], colormap= :plasma)  #colorrange = (7.5e-5, 3.6e-5))
cont = contour!(ax, lat, z,  b_r[lon_index, :, :], color=:black, linewidth=3, levels=contours_log, labels = false,
labelsize = 30, labelfont = :bold, labelcolor = :black)
display(fig)
save("figures/ta_strat_quarter.png", fig)