...
interp_init = false
init_file = "/storage2/WenoNeverworldData/weno_fourth_checkpoint_iteration38352605.jld2" #weno_four_checkpoint_iteration995943.jld2"
...
# Adaptable time step
wizard = TimeStepWizard(; cfl = 0.35, max_Δt = 35minutes, min_Δt = 15minutes, max_change = 1.1)
