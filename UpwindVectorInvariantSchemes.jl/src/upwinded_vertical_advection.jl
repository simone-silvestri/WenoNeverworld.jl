...
@inline function vertical_advection_U(i, j, k, grid, scheme::UpwindVerticalVectorInvariant, U)
    ...
    @inbounds û = u[i, j, k] 
    δᴸ    =  _left_biased_interpolate_xᶠᵃᵃ(i, j, k, grid, scheme, div_xyᶜᶜᶜ, VI, u, v)
    δᴿ    = _right_biased_interpolate_xᶠᵃᵃ(i, j, k, grid, scheme, div_xyᶜᶜᶜ, VI, u, v)
...
@inline function vertical_advection_V(i, j, k, grid, scheme::UpwindVerticalVectorInvariant, U)
    ...
    @inbounds v̂ = v[i, j, k] 
    δᴸ    =  _left_biased_interpolate_yᵃᶠᵃ(i, j, k, grid, scheme, div_xyᶜᶜᶜ, VI, u, v)
    δᴿ    = _right_biased_interpolate_yᵃᶠᵃ(i, j, k, grid, scheme, div_xyᶜᶜᶜ, VI, u, v)
